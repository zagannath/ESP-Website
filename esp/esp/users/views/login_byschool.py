...
class BarePasswordForm(FormWithRequiredCss):
    """ Just a password. """
    password = forms.CharField(label='Password', widget=forms.PasswordInput(), help_text='If you forgot your password, email <a href="mailto:queens-websupport@lists.learningu.org">us</a>. Please do not create a new account.')
